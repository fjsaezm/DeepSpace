...
module Deepspace
  ...
  class TestP4
    ...
    def createDamageSpecific
      ...
      dSpecific1 = SpecificDamage.new(array1,0)
      dSpecific2 = SpecificDamage.new(array2,1)
      dSpecific3 = SpecificDamage.new(array3,2)
      dSpecific4 = SpecificDamage.new(array4,3)
      dSpecific5 = SpecificDamage.new(array5,0)
      dSpecific6 = SpecificDamage.new(array6,5)
